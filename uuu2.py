...
from PIL import Image, ImageTk  # Se agregó ImageTk para usar las imágenes en Tkinter
import calendar
from tkinter import *
...
def ventana_bienvenida():
    ...
    etiqueta=Label(bienvenida_window, image=imagen)
    etiqueta.place(x=82, y=160)
